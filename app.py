...
def process_data(df):
    ...
    # Name sütununu Owner olarak belirle
...
try:
    ...
    if st.sidebar.button("Generate Color PDF Report"):
        with st.spinner("Generating PDF..."):
            ...
            st.sidebar.download_button(
                ...
                data=pdf_data,
                file_name="SM_Analytics_Report.pdf",
    ...
    # --- EN ALTTAKİ VERİ TABLOSU ---
    st.divider()
    st.subheader("📋 Detailed Content Data Table")
    # Kullanıcıya tüm kolonları göstermek için tabloyu yerleştiriyoruz
